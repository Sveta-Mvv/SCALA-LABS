...
object Strings extends App{
  ...
  println(testUppercase("Hello from big brother!"))
  ...
  println(testInterpolations("Sveta",20))
  ...
  def testComputation(a: Int, b: Int): String = s"Hi,\nnow follows a quite hard calculation. We try to add:" + s"\n  a := $a\n  b := $b\n result is ${a+b}"
  println(testComputation(25,5))
  ...
  println(testTakeTwo("Marvel`s movies are amazing!"))
}
